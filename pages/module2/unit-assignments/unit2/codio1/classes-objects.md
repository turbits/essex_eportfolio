---
layout: page
permalink: /pages/module2/unit-assignments/unit2/codio1/classes-objects.html
---

⬅️[Back](/pages/module2/unit-assignments/unit2/codio1/codio1.html)

# Module 2: Assignment 3: Unit 2: Codio Activity 1: Classes and Objects
...
distance_between_points([5.0, 6.0], [9.0, 15.0]) =  9.8488578018


---- move_rectangle() ----
changes the location of the rectangle by adding dx to the x coordinate of corner and adding dy to the y coordinate of corner
move_rectangle(Rectangle(100, 200, Point(50, 50)), 10, 10) = width:100, height:200, corner.x:60, corner.y:60


---- move_rectangle_copy() ----
returns a new Rectangle instead of modifying the old one
original rectangle = width:100, height:200, corner.x:50, corner.y:50
move_rectangle_copy(Rectangle(100, 200, Point(50, 50)), 10, 10) = width:100, height:200, corner.x:60, corner.y:60
original rectangle (again) = width:100, height:200, corner.x:50, corner.y:50


---- point_in_circle() ----
returns True if the Point lies in or on the boundary of the circle
point_in_circle(Circle(Point(150, 100), 75), Point(100, 75)) =  True


---- rect_in_circle() ----
returns True if the Rectangle lies entirely in or on the boundary of the circle
rect_in_circle(Circle(Point(150, 100), 75), Rectangle(50, 100, Point(100, 50))) =  True


---- rect_circle_overlap() ----
returns True if any of the corners of the Rectangle fall inside the circle
rect_circle_overlap(Circle(Point(150, 100), 75), Rectangle(50, 100, Point(100, 50))) =  True
```

The program also opens a window and draws the rectangle and circle using the turtle module.
