---
layout: page
permalink: /pages/module2/assignment2
published: false
---

## Module 2: Assignment 2: System Implementation

This assignment was to take the system design we did in [assignment 1](/pages/module2/assignment1) and implement it in Python. We were required to use an unsupported version of Python, as we were also given a "Codio" environment, which had "2.7.15+" installed, which did not seem to work with Python 3 functions.

### Table of Contents

- 📝[Code - Markdown](#) Unfortunately, this project was a big too big to fit into a Markdown file, so I have included a link to the repository below.
- 🧑‍💻[Python Program - Autonomous Vehicle System (External Repo)](https://github.com/turbits/essex-m2a2)
- 📝[Requirements Outline - Markdown](/pages/module2/assignment2/requirements)
- 📝[Development Process - Markdown](/pages/module2/assignment2/development-process)
- 📜[Development Process - docx](./development-process.docx)
