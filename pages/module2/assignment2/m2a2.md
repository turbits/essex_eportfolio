---
layout: page
permalink: /pages/module2/assignment2.html
---

## Module 2: Assignment 2: System Implementation

This assignment was to take the system design we did in [assignment 1](/pages/module2/assignment1.html) and implement it in Python. We were required to use an unsupported version of Python, as we were also given a "Codio" environment, which had "2.7.15+" installed, which did not seem to work with Python 3 functions.
