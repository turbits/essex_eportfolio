...
This assignment had a broad (vague) requirements set, which made it fairly confusing, not to mention that it does not explicitly state that, in the subsequent module, you will be building this system in Python using your design. Nontheless I did my best to interpret the requirements and create a system that meets them.
...
- Provision capability in your system to reain data within the following data structures: (Knowledge and Understanding weighted at 25%)
  - List
  - Stack (in Python (2 at least): a list that is treated in a LIFO manner)
  - Queue (I used deque)
  - Dictionary
...
- And finally, an additional _required_ five (5!) references, in a 500 word essay..
